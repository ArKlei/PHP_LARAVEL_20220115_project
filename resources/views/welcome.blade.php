...
<div id="mySidenav" class="sidenav">
  ...
  <a href="{{route('company.create')}}" id="create_company">Add company</a>
    ...
    <div class="container">
        <div style="text-align:center; font-size:400px; color:gold">C R M</div>
        <p>
        <div style="text-align:center; font-size:50px; color:platinum">Our Clients & Partners are value</div>
